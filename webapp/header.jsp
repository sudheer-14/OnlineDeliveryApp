...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		...
		<h6>Experience the best online shopping with us. Easy, fast, and secure.</h6>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" ><span
					class="glyphicon glyphicon-home">&nbsp;</span>ONLINE DELIVERY APPLICATION</a>
			</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="index.jsp?type=fashion&beauty">Fashion and Beauty</a></li>
							<li><a href="index.jsp?type=Toys&Games">Toys & Games</a></li>
							<li><a href="index.jsp?type=health&household">Helath & Household</a></li>
							<li><a href="index.jsp?type=Home&Kitchen">Home & Kitchen </a></li>
						</ul></li>
				</ul>
			</div>
		</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="userHome.jsp?type=fashion&beauty">Fashion and Beauty</a></li>
							<li><a href="userHome.jsp?type=Toys&Games">Toys & Games</a></li>
							<li><a href="userHome.jsp?type=health&household">Health & Household</a></li>
							<li><a href="userHome.jsp?type=Home&Kitchen">Home & Kitchen</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="adminViewProduct.jsp?type=fashion&beauty">Fashion and Beauty</a></li>
							<li><a href="adminViewProduct.jsp?type=Toys&Games">Toys & Games</a></li>
							<li><a href="adminViewProduct.jsp?type=health&household">Health & Household</a></li>
							<li><a href="adminViewProduct.jsp?type=Home&Kitchen">Home & Kitchen</a></li>
						</ul></li>

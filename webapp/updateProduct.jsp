...
<%@ page
	import="com.service.impl.*, com.service.*,com.Beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="fashion&beauty"
								<%="fashion&beauty".equalsIgnoreCase(ptype) ? "selected" : ""%>>FASHION AND BEAUTY</option>
								<option value="Toys&Games"
								<%="Toys&Games".equalsIgnoreCase(ptype) ? "selected" : ""%>>TOY AND GAMES</option>
								<option value="health&household"
								<%="health&household".equalsIgnoreCase(ptype) ? "selected" : ""%>>HEALTH AND HOUSEHOLD</option>
							<option value="other"

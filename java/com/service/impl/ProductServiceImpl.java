...
public class ProductServiceImpl implements ProductService {
	...
	/*public List<ProductBean> getAllProducts() {
	    ...
	    try {
	        // Ensure this method is correctly returning a non-null connection
	    	...
	    	DBUtil.closeConnection(con);
			DBUtil.closeConnection(ps);
			DBUtil.closeConnection(rs);  // Ensure proper resource cleanup
	    }
...
*/
	...
	public List<ProductBean> getAllProductsByType(String type) {
		...
		try {
			ps = con.prepareStatement("SELECT * FROM shoppingcart.product where lower(ptype) like ?;");
			ps.setString(1, "%" + type + "%");
			rs = ps.executeQuery();
	...
	public List<ProductBean> searchAllProducts(String search) {
		...
		try {
			ps = con.prepareStatement(
					"SELECT * FROM shoppingcart.product where lower(ptype) like ? or lower(pname) like ? or lower(pinfo) like ?");
			search = "%" + search + "%";
